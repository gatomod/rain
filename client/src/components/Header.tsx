...
const Header = () => {
	return (
		<div className='flex justify-between items-center bg-slate-800 px-5 py-3 select-none'>
			...
			<div>
				<p className='font-bold font-nunito text-slate-200 text-lg hover:underline active:text-slate-400 transition-all'>
					Subir vídeo
				</p>
			</div>
		</div>
